...
#ActionBarSherlock、Amazon Ads、Apache logging、ButterKnife、Cordova、Couchbase Lite、Dagger、Ektorp、
#Facebook API、Facebook Conceal、Google API、Google Cloud Messaging、Google Play Services、
#Google Play market LVL、Google Play market expansion、Guava、Jackson、Java mail、LogBack、
#Nuance Vocalizer、OrmLite、Retrofit、RoboGuice、SQLCipher、Tapjoy、libGDX
